...
//		String teststring = "das aktuelle Datun ist:"+ new Date();
//		System.out.println(teststring);
//		String s = "Herr, schmeiﬂ Java vom Himmel!";
...
//		  System.out.println( k );	
	    ...
	    for ( int guesses = 1; ; )
	    {
	      ...
	      System.out.printf( "Runde %d. Bisher geraten: %s. Was w‰hlst du f¸r ein Zeichen?%n", guesses, guessedWord );
